...
urlpatterns = [
    ...
    path('ksl-begin', views.ksl_beginning, name="ksl-begin"),
    path('ksl-watch', views.ksl_watch, name="ksl-watch"),
    path('kikuyu/next/', views.kikuyu_hear_it, name="kikuyu_hear_it"),
    path('kikuyu_family/next/', views.kikuyu_family_audio,
         name="kikuyu_family_audio"),
